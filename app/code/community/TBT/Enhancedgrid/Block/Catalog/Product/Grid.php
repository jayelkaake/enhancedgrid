...
//                    'width' => '150px'
    ...
    protected function _preparePage() {
        ...
        $collection
                ->joinField('categories', $ccev_t, 'GROUP_CONCAT(_table_categories.value)', 'entity_id=category_id', "_table_categories.attribute_id={$category_name_attribute_id}", 'left');
        $collection
                ->joinField('category', $ccev_t, 'value', 'entity_id=category_id', "_table_category.attribute_id={$category_name_attribute_id}", 'left');
